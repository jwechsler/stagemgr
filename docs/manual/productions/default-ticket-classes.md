...
| **Admission type** | In person (default), Virtual (streaming), or Other -- decides printing, ticket counts and email copy. See [Admission](ticket-classes.md#admission-how-patrons-attend) |
