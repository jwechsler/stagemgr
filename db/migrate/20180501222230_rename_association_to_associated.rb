class RenameAssociationToAssociated < ActiveRecord::Migration[4.2]
  def self.up
    if index_exists? :audits, %i[association_id association_type], name: 'association_index'
  ...
  def self.down
    if index_exists? :audits, %i[associated_id associated_type], name: 'associated_index'
    ...
    add_index :audits, %i[association_id association_type], name: 'association_index'
  end
end
