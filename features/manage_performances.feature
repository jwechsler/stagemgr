Feature: A box office worker can create performances associated with a production.  Performances are scheduled performances of a particular production
