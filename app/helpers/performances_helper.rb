module PerformancesHelper
  def price_range(performance)
    visible = performance.ticket_class_allocations.select { |tca| !tca.ticket_class.nil? && tca.available? && tca.ticket_class.web_visible? && tca.ticket_class.holds_seats? && tca.ticket_class.show_in_pricing_range? }
