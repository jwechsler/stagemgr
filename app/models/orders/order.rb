...
"Canceled", "Unclaimed", "Split").freeze
  ...
  def set_email_confirmation
    # now = DateTime.now
    # if !self.performance.nil? && (self.performance.performance_date > Date.current || (self.performance.performance_date == Date.current && self.performance.performance_time > Time.now - (60*60)))
