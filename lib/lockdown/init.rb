...
# Logged in Access
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  set_permission(:logged_in).with_controller(:user_sessions).
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  set_permission(:theater_management).
    with_controller(:theaters).
    only_methods(:new, :create, :edit, :update, :destroy)

  set_permission(:theater_view).
    with_controller(:theaters).
    only_methods(:index, :show)
 
  set_permission(:production_management).
    with_controller(:productions).
    only_methods(:new, :create, :edit, :update, :destroy)

  set_permission(:production_view).
    with_controller(:productions).
    only_methods(:index, :show)
  ...
  set_protected_access :logged_in, :my_account
  ...
  set_user_group(:administrator, 
                 :theater_management, :theater_view,
                 :production_management, :production_view)
