...
class Admin::SpecialFeaturesControllerTest < ActionController::TestCase
  ...
  def test_show
    get :show, params: { id: SpecialFeature.first }
  ...
  def test_edit
    get :edit, params: { id: SpecialFeature.first }
    assert_template 'edit'
  end

  def test_update_invalid
    SpecialFeature.any_instance.stubs(:valid?).returns(false)
    put :update, params: { id: SpecialFeature.first }
    assert_template 'edit'
  end
  ...
  def test_destroy
    ...
    delete :destroy, params: { id: special_feature }
    assert_redirected_to admin_special_features_url
    assert_not SpecialFeature.exists?(special_feature.id)
  end
end
